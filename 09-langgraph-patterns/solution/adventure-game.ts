...
const scenes: Record<string, SceneData> = {
  ...
  cave: {
    description: "You discover a mysterious cave entrance. Strange glowing symbols adorn the walls.",
    choices: [
  ...
  treasure_or_trap: {
    ...
    choices: [
      { text: "Carefully approach and open the chest", nextScene: "treasure_ending", item: "golden_amulet" },
      { text: "Look for another way around", nextScene: "secret_passage" },
    ],
  },
  hidden_item: {
    description: "You find an ancient map hidden in the rocks!",
    choices: [{ text: "Take the map and enter the cave", nextScene: "treasure_or_trap", item: "ancient_map" }],
  },
  village: {
  ...
  waterfall: {
    ...
    choices: [
      { text: "Explore the cave behind the waterfall", nextScene: "waterfall_cave" },
  ...
  secret_passage: {
    ...
    choices: [{ text: "Claim the treasure", nextScene: "treasure_ending", item: "ancient_treasure" }],
  },
  waterfall_cave: {
    description: "Behind the waterfall, you find a legendary artifact!",
    choices: [{ text: "Take the artifact and return home", nextScene: "legendary_ending", item: "water_crystal" }],
  },
  new_quest: {
  ...
  // Endings
  treasure_ending: {
    description: "You've found incredible treasure! You return home wealthy and celebrated. THE END.",
    choices: [],
  },
  peaceful_ending: {
  ...
  dragon_ending: {
    description: "You help the dragon and gain a powerful ally. Together you protect the realm! THE END.",
    choices: [],
  },
};
