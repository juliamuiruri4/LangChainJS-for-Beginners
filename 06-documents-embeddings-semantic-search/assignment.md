# Chapter 6 Assignment: Documents, Embeddings & Semantic Search
...
- Completed Chapter 5 (Agents & MCP)
...
**Tasks**:
1. Create `similarity-explorer.ts` in the `06-documents-embeddings-semantic-search/solution/` folder
...
**[Chapter 7: Building Agentic RAG Systems](../07-agentic-rag-systems/README.md)**
